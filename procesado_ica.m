...
function [comp_ica_sujeto,T1,T2] = procesado_ica(data,t)

% -------------------------------------------------------------------------
%   PROCESADO_ICA realiza cinco filtros paso banda centrados en las
...
%   cual hay que modificar en double_audio_analysis_eeg.m)
%
%   INPUT ---------------------------------------------
%
%   data                        Estructura de datos tras ICA de un sujeto
%                               previamente cargado
%
...
%% TABLAS CON RELACIONES DE MÚSICA Y VOZ para usar classificationLearner

% double_audio_analysis.m -> Dos tablas con las relaciones de energías de
%                            una pista musical y voz
%                           (cada tabla incluye la mitad de datos, T1 y T2)
%
% total_audio_analysis.m -> Dos tablas con las relaciones de energías de
%                           todas las pistas 
%                           (cada tabla incluye la mitad de datos, T1 y T2)
